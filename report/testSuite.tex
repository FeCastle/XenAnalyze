In order to test our design, a test infrastructure was created to place a load on the guest machines and coordinate the stop and start of the collection of resources.   

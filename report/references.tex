...
\bibitem{iostats} Lindsley, Rick.  \emph{I/O statistics fields.} \url{https://www.kernel.org/doc/Documentation/iostats.txt}
\bibitem{proc} Bowden, T., Bauer, B., Nerin, J., Feng, S.  \emph{THE /proc FILESYSTEM.} \url{https://www.kernel.org/doc/Documentation/filesystems/proc.txt}
\bibitem{diskstats} Merchand, Jerome. \emph{I/O statistics of block devices.} \url{https://www.kernel.org/doc/Documentation/ABI/testing/procfs-diskstats}
